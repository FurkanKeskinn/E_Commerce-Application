...
import com.example.e_commerceapplication.databinding.FragmentCartPageBinding
...
class CartPage : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCartPageBinding.inflate(layoutInflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.continueBtn.setOnClickListener {
            findNavController().navigate(R.id.action_cartPage_to_homePage)
        }
    }
}